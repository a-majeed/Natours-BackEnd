...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYXphYW5tYWplZWQiLCJhIjoiY2t0OWNjbDk0MWFyNjJvbGpuajlibHQ0NSJ9.W974ahK6vGpACy7xTPARfQ';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/azaanmajeed/ckt9ck3hz3hji17n0ktuduy2k',
...
module.exports = {
  ...
  "_spec": "axios",
  "_where": "C:\\Users\\user\\Desktop\\4-natours",
  "author": {
    "name": "Matt Zabriskie"
  },
  "browser": {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            stripe = Stripe('pk_test_51JXDSaL1vcnKjlRS0W0b5kDf4VJ6ach5DeJQ7dC8U4AwTEMXODOonVmS5XPJaxcQTCkuHubZxhtLbObdOLVTqlpt005HXMpdA6');
            _context.next = 4;
